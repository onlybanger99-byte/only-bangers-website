          ...
          <div className={styles.section}>
            ...
            <div className={styles.contactInfo}>
              ...
              >
                ...
                123 Barber Street, Sandton, Johannesburg
              </a>
              <a href="tel:+27699864730" className={styles.contactItem}>
                <svg className={styles.contactIcon} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                +27 69 986 4730
              </a>
              <a href="mailto:onlybangers99@gmail.com" className={styles.contactItem}>
                <svg className={styles.contactIcon} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className={styles.extra}>
          <div className={styles.socialSection}>
            ...
            <div className={styles.socialIcons}>
              ...
              >
                <svg className={styles.socialSvg} viewBox="0 0 24 24" fill="white">
